import 'package:apk_doa/doa/all_doa_list.dart';
import 'package:apk_doa/dzikir/content_dzikir.dart';
                      ...
                      child: Row(
                        children:<Widget> [
                          Padding(
                            ...
                            child: Hero(
                                tag: 'Bacaan Sholat',
                                child: Image(image: AssetImage('assets/img/praying.png'),width: 30,
                                )
                            ),
                          ),
                          Center(
                            child: Padding(
                              ...
                              child: Column(
                                ...
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: <Widget>[
                                  Text('Bacaan Sholat', style: cardTitle),
                                  Container(
                                      margin: EdgeInsets.only(top: 4.0),
                                      child: Text('Niat Sholat\n Bacaan ketika Sholat',
                                          style: tagLine,maxLines: 2,))
                                ],
                              ),
                            ),
