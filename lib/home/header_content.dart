                  ...
                  child: Column(
                    children:  <Widget>[
                      Text('Kumpulan Doa Harian',
                          style: TextStyle(decoration: TextDecoration.none, fontSize: 20, fontWeight: FontWeight.bold, color: Colors.white)),

                      Text('Dengan Mengingat Allah\nHati Menjadi Tenang',
                        style: TextStyle(decoration: TextDecoration.none, color: Colors.white,fontSize: 12,fontWeight: FontWeight.normal),maxLines: 2,)
                    ],
                  ),
                ),
              )
