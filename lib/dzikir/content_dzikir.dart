import 'package:apk_doa/dzikir/detail_dzikir.dart';
import 'package:apk_doa/model/dzikir.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Kumpulan Bacaan Dzikir', style: TextStyle(color: Colors.white),),
      ),
      body: Container(
